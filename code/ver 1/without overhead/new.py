...
def schedule_tied(num_tasks, num_threads, part_list, desc_rel, schedule_alg, alloc_alg):
...
def schedule_untied(num_tasks, num_threads, part_list, schedule_alg, alloc_alg):
...
def execute(task_type, num_tasks, num_threads, part_list, deadline, desc_rel, first_task_part, schedule_alg, alloc_alg, graphic_result):
	...
	if task_type == 'tied':
		...
		t = schedule_tied(num_tasks, num_threads, part_list, desc_rel, schedule_alg, alloc_alg)
	else:
		print('\nNEW for untied tasks (' + schedule_alg + ', ' + alloc_alg + ')' + '\n***********************************')
		t = schedule_untied(num_tasks, num_threads, part_list, schedule_alg, alloc_alg)
